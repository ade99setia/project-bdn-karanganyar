...
class DashboardController extends Controller
{
    public function sales()
    {
        ...
        if (!$user->phone) {
            return redirect()->route(route: 'profile.edit')->with('warning', 'Silakan lengkapi nomor telepon Anda terlebih dahulu di halaman profil sebelum mengakses dashboard.');
        }
