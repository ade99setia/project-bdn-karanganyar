                        ...
                        {value.map((id) => {
                            ...
                            return (
                                <div key={id} className="flex items-center gap-2 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 px-2 py-1 rounded-xl text-xs font-semibold max-w-xs">
                                    <div className="w-6 h-6 rounded-full bg-zinc-100 dark:bg-zinc-800 overflow-hidden shrink-0 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center">
                ...
                {showResults && (
                    ...
                    >
                        {filtered.map(i => (
                            ...
                            >
                                <div className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800 overflow-hidden shrink-0 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center">
                        ...
                        {query.trim().length > 0 && filtered.length === 0 && (
                            <div className="p-4 text-center text-zinc-500 text-xs italic">Member tidak ditemukan...</div>
                        )}
                    </motion.div>
                )}
            </AnimatePresence>
