                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                        ...
                        >
                            <div className="px-6 py-5 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between sticky top-0 bg-white dark:bg-zinc-900 z-10">
                                <div>
                                    <h3 className="text-lg font-bold text-blue-900 dark:text-blue-100">Input Kunjungan</h3>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Tulis hasil pertemuan, respon pelanggan, atau kendala di lapangan..."
                                        />
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="mb-6">
                                    <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2">Catatan Kunjungan</h4>
