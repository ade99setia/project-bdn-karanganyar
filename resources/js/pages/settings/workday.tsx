            ...
            <SettingsLayout>
                <div className="mx-auto max-w-4xl space-y-6">
                    ...
                    {(flash?.success || flash?.error || flash?.warning || flash?.info) && (
                        <div className={`rounded-xl border p-4 text-sm font-medium shadow-sm transition-all ${
                            flash?.success ? 'border-emerald-200 bg-emerald-50 text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-900/20 dark:text-emerald-300'
