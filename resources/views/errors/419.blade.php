...
<head>
    ...
    <title>419 Session Expired - Bagus Dinamika Nusantara</title>
...
<body>
    ...
    <div class="container">
        ...
        <p class="error-message">
            Sesi Anda telah berakhir karena tidak ada aktivitas atau token keamanan kadaluarsa.
        ...
        <div class="bottom-logo">
            <a href="https://wa.me/628600190898?text=Saya mendapatkan error 419. URL: {{ request()->url() }} Message: {{ $exception->getMessage() }}"
