...
<head>
    ...
    <title>403 Forbidden - Bagus Dinamika Nusantara</title>
...
<body>
    ...
    <div class="container">
        ...
        <p class="error-message">
            {{ $exception->getMessage() ?: 'Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Area ini dilindungi atau terbatas untuk peran tertentu.' }}
        </p>
        ...
        <div class="bottom-logo">
            <a href="https://wa.me/628600190898?text=Saya mendapatkan error 403. URL: {{ request()->url() }} Message: {{ $exception->getMessage() }}"
                target="_blank" class="button" style="margin-left: 1rem; background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); box-shadow: 0 10px 24px -6px rgba(249, 115, 22, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.05);">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path
