...
<body>
    ...
    <div class="container">
        ...
        <p class="error-message">
            {{ $exception->getMessage() ?: 'Maaf, website sedang dalam perbaikan/maintenance. Silakan kembali beberapa saat lagi atau hubungi admin jika urgent.' }}
        </p>

        <a href="https://wa.me/6285600190898" class="button" target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path
                    d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8v-3.18c-2.83-.48-5-2.94-5-5.62 0-3.31 2.69-6 6-6s6 2.69 6 6c0 2.68-2.17 5.14-5 5.62v3.18c4.56-.93 8-4.96 8-9.8z" />
        ...
        <div class="bottom-logo">
            <a href="https://wa.me/628600190898?text=Saya mendapatkan error 503. URL: {{ request()->url() }} Message: {{ $exception->getMessage() }}"
